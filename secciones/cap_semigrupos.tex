...
\begin{Observacion}
    ...
    A pesar de que $T(t)^*$ es un semigrupo, no necesariamente es un $C_0$-semigrupo (véase \cite[5.14]{engel-1999-one-sem-lin}).
...
\begin{Definicion}{(Generador del semigrupo dual)}
    ...
    Véase \cite[2.5]{engel-1999-one-sem-lin} para un estudio más riguroso.
\end{Definicion}
