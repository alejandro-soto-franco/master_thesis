...
\begin{proof}
    La primera afirmación se prueba trivialmente aplicando el Teorema de Lumer-Philips \ref{ch:semigrupos:th:LumerPhillips}. En concreto, se aplica $2$ y luego $1$, lo cual concluye la demostración de la primera afirmación.
