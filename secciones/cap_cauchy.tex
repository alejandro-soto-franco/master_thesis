...
\begin{proof}
    ...
    Finalmente, por lo dicho al comienzo (entiéndase: que $t \mapsto \mathrm{e}^{A(t-t_0)}e_0$ es de clase $C^1$ por ser $e_0$ un elemento de $D(A)$), se tiene que $\displaystyle \frac{\dd^+}{\dd t}e(t)$ existe (pues $\displaystyle \frac{\dd^+}{\dd t}e(t) = \frac{\dd^+}{\dd t}\Big(\mathrm{e}^{A(t - t_0)}e_0 \Big) + \frac{\dd^+}{\dd t}u(t)$) y $\displaystyle t \mapsto \frac{\dd^+}{\dd t}e(t)$ es continua. Así, por el cuarto punto del Teorema \eqref{ch:cauchy:section:noHom:th:solDebilYFuerteRels}
